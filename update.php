                    ...
                    <form class="needs-validation" novalidate action="updateHandler.php" method="POST">
                        ...
                        if (isset($_GET["_id"]) && !empty(trim($_id))) {
                            ...
                            if (pg_num_rows($result) == 1) {
                                ...
                                echo "<div class='mb-3'><label for='prodprice'>Price</label><input type='number' step='0.01' class='form-control' id='prodprice' name='prodprice' value='" . $row['prodprice'] . "' required><div class='invalid-feedback'>Enter just the number.</div></div>";
